...
fun SelectFleetDialog(
    ...
    val filteredFleets = remember(searchQuery) {
        fleetList.filter { it.registration_number.contains(searchQuery, ignoreCase = true) }
    }
            ...
            Column(
                ...
                LazyColumn(
                    ...
                    items(filteredFleets) { fleet ->
                        Text(
                            text = fleet.registration_number,
                            modifier = Modifier
                                .fillMaxWidth()
                                .padding(12.dp)
                                .clickable {
